		...
		if ($uname) {
			...
			$timeline .= '
			    ...
			    <div class="mood" id="target_'. $counter .'" style="width:670px;height:80px;background-color:white;">
					<br/>
					<img src="img/emoticon/happy.jpg" width="50" height="20" id="happy" title="happy" alt="happy" onclick="getMood(this.id, ' .$row['sid']. ', '.$row['userid'].')" />
					<img src="img/emoticon/sad.jpg" width="50" height="20" id="sad" title="sad" alt="sad" onclick="getMood(this.id, ' .$row['sid']. ', '.$row['userid'].')" />
					<img src="img/emoticon/surprised.jpg" width="50" height="20" id="surprised/afraid" title="surprised/afraid" alt="surprised" onclick="getMood(this.id, ' .$row['sid']. ', '.$row['userid'].')" />
					<img src="img/emoticon/angry.jpg" width="50" height="20" id="angry/disgusted" title="angry/disgusted" alt="angry" onclick="getMood(this.id, ' .$row['sid']. ', '.$row['userid'].')" />
					<br/>
				</div>';
		} else {
...
function getMood(mood, songid, userid) {
	$('#waiting').show(500);
	$('.mood').hide(0);
	$('#message').hide(0);
...
function getMoodsss(mood, songid, userid) {
	$('#waiting').show(500);
	$('.mood').hide(0);
	$('#message').hide(0);
	...
	if (window.XMLHttpRequest) {
  	...
  	xmlhttp.open("GET","includes/get_mood.php?mood="+mood+"&songid="+songid+"&userid="+userid,true);
  	//xmlhttp.open("GET","includes/get_mood.php?mood="+mood,true);
  	xmlhttp.send();
}
</script>
